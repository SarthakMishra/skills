...
Identify the primary information and action, then inspect the hierarchy in its
surrounding screen. Use the repair table below when diagnosing a visible problem.
...
### Check overflow and missing detail
