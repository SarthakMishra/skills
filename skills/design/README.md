...
automatically coordinates the other four design skills and carries the result
...
| UI fundamentals and design critique                            | `ui-guide`        |
...
- [ui-guide](ui-guide/SKILL.md): Choose and review UI fundamentals, interaction feedback, and motion design. [Usage](ui-guide/README.md).
