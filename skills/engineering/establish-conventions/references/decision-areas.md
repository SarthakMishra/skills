...
Inspect each decision area during the interview and proposal. Pursue only the
branches supported by the spec or existing code.
...
### Behavior, state, and compatibility
...
### Control test inputs and dependencies
