...
### Use WeKeep's product vocabulary

Use `WeKeep` for the product. Follow the established vocabulary and persona-label conventions in [apps/web/CONTEXT.md](../../../apps/web/CONTEXT.md) and its domain references. Preserve professional accounting terms for Chartered Accountants; use the existing plain-language labels for client-facing flows.
